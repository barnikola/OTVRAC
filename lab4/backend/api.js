    ...
    try {
        ...
        const jsonLdResponse = {
            "@context": {
                ...
                "Pozicija": "roleName",
                "Godina_prikljucenja": "startDate",
                "Naziv": "name",
                "Zemlja": "addressCountry",
                "Godina_osnutka": "foundingDate",
                "Skracenica": "identifier",
                "Esport": "sport",
                "Broj_trofeja": "numberOfAwardsWon",
                "Pobjede2023": "wins",
                "Porazi2023": "losses",
                "Regija": "region",
                "Ukupna_zarada": "monetaryAmount"
            },
            teams: customJSON
        };
...
router.get('/igraci/:id', async (req, res) => {
    ...
    try {
        ...
        if (result.rows.length > 0) {
            ...
            const jsonLdPlayer = {
                "@type": "Property :: athlete",
                "@context": {
                    "@vocab": "http://schema.org/",
                    "Ime": "givenName",
                    "Prezime": "familyName",
                    "Nickaname": "alternateName",
                    "Pozicija": "jobTitle",
                },
                Ime: player.ime,
                ...
                Godina_prikljucenja: player.godina_prikljucenja,
                Team: {
                    "@type": "SportsTeam",
                    "@context": {
                        "@vocab": "http://schema.org/",
                        "Naziv": "name",
                        "Skracenica": "alternateName"
                    },
                    Naziv: player.naziv,
                    Skracenica: player.skracenica
                }
            };
            res.status(200).json(jsonLdPlayer);
        } else {
            res.status(404).json({
                status: "error",
                message: `Player with id ${id} not found.`,
